...
class FlightDataWindow(QtWidgets.QMainWindow): # Die Gesamtdarstellung der flight data
    def __init__(self):
        ...
        self.port = serial.Serial("COM6", 9600, timeout = 1)
        self.reader = None
        ...
        # ...
        # RESET_PRIMARY: Resets the Primary MCU on the flight computer                                          j
        # RESET_SECONDARY: Resets the Secondary MCU on the flight computer                                      j
        # ...
